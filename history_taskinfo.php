            ...
            <div class="rc_list">
                <div class="rl_list">
                    <table class='lt' width="100%" border=0 cellpadding=2 cellspacing=0 style="table-layout:fixed;">
                        ...
                        <tr><td height="37" class=nl>追号内容：</td><td style="word-break:break-all;white-space:normal; width:85%;overflow:hidden;word-wrap:break-word;"><?=dcode($row['codes'],$row['lotteryid'],$row['mid'])?></td><td height="37" class=nl>追号状态：</td><td><?php if($row['zt']==0){echo "进行中";}else{echo "已完成";}?></td></tr>
...
?>
                            <tr>
                                ...
                                <td><?php if($rowa['zt']==1){?><a href="./history_playinfos.php?id=<?=$rowa['danb']?>" target="_blank" class="blue">详情</a><?php }?></td>
                            </tr>
<?php }?>
                        </table>
                    </div>

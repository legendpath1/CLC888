...
$_SESSION["mainframe"] = '"./ws_money_in.php"';
?>
...
<div class="top_menu">
    ...
    <div class="tm_menu">
        <a href="/account_drawlist.php">提现记录</a>
        <a href="/account_draw.php">平台提现</a>
        <a href="/account_savelist.php">充值记录</a>
        <a href="/account_autosavea.php">在线充值</a>

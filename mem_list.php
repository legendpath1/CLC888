...
//		}
		...
		$sql = "insert into ssc_member set username='" . $_REQUEST['username'] . "', password='" . md5($_REQUEST['userpass']) . "', nickname='" . $_REQUEST['nickname'] . "', regfrom='', regup='', regtop='', flevel='" . $flevel . "', zc='" . $zc . "', pe='" . $_REQUEST['pe'] . "', banks='" . $_REQUEST['banks'] . "', level='" . $_REQUEST['usertype'] . "', regdate='" . date("Y-m-d H:i:s") . "'";
		$exe = mysql_query($sql);
	...
	if($_POST['button']=="充 值" || $_POST['button']=="扣 款"){
		...
		if($_REQUEST['userpass']==""){
			if($_REQUEST['cwpassword']==""){
				$sql = "update ssc_member set nickname='" . $_REQUEST['nickname'] . "', flevel='" . $flevel . "', zc='" . $zc . "', pe='" . $_REQUEST['pe'] . "', banks='" . $_REQUEST['banks'] . "', level='" . $_REQUEST['usertype'] . "' where id='" . $_GET['uid'] . "'";
			}else{
				$sql = "update ssc_member set cwpwd='" . md5($_REQUEST['cwpassword']) . "', nickname='" . $_REQUEST['nickname'] . "',  flevel='" . $flevel . "', zc='" . $zc . "', pe='" . $_REQUEST['pe'] . "', banks='" . $_REQUEST['banks'] . "', level='" . $_REQUEST['usertype'] . "' where id='" . $_GET['uid'] . "'";
			}
		}else{
			if($_REQUEST['cwpassword']==""){		
				$sql = "update ssc_member set password='" . md5($_REQUEST['userpass']) . "', nickname='" . $_REQUEST['nickname'] . "',  flevel='" . $flevel . "', zc='" . $zc . "', pe='" . $_REQUEST['pe'] . "', banks='" . $_REQUEST['banks'] . "', level='" . $_REQUEST['usertype'] . "' where id='" . $_GET['uid'] . "'";		
			}else{
				$sql = "update ssc_member set password='" . md5($_REQUEST['userpass']) . "', cwpwd='" . md5($_REQUEST['cwpassword']) . "', nickname='" . $_REQUEST['nickname'] . "', flevel='" . $flevel . "', zc='" . $zc . "', pe='" . $_REQUEST['pe'] . "', banks='" . $_REQUEST['banks'] . "', level='" . $_REQUEST['usertype'] . "' where id='" . $_GET['uid'] . "'";
			}
		}
		$exe = mysql_query($sql) or  die("数据库修改出错2");

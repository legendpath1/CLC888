<?php 
	...
	$amount = !isset($_REQUEST['amount'])?"10":$_REQUEST['amount'];
	$transCur = !isset($_REQUEST['transCur'])?"156":$_REQUEST['transCur'];
	$accountType = !isset($_REQUEST['accountType'])?"1":$_REQUEST['accountType'];
	$bankId = !isset($_REQUEST['bankId'])?"ICBC":$_REQUEST['bankId'];
	$productName = !isset($_REQUEST['productName'])?"测试商品":$_REQUEST['productName'];

...
if($id==1 || $id==5 || $id==6 || $id==7 || $id==12 || $id==14){
	$ns=5;
	$nts=50;
	$ntx=0;
	$ntd=9;
...
<?php
	...
	if($starttime!="" && $endtime!=""){
		$sqla="select code from ssc_data where cid='".$id."' and addtime <'".$starttime." 00:00:00' order by issue desc limit 100";
	}else{
		$sqla="select code from ssc_data where cid='".$id."' order by issue desc limit ".$total.",100";
	}
//	echo $sqla;

...
<div class=" game_rc" style="width:98%;"> 
    <div class="gm_con help_con">
        ...
        <div class="help_menu" id="help_menu">
            ...
            <a class="act" href="./help_fun.php"><strong>功能介绍</strong></a>
        </div>
        <div class="gm_con_to">
                ...
                <div class="unit">
                    <div class="unit_title">
                        ...
                        <div class="u_tab_div" id="tab">
                                                        <span id="tab_0" class="u_tab_hover"><a>会员中心</a></span>
                                                        <span id="tab_1" class="u_tab_no"><a>开始游戏</a></span>
                                                        <span id="tab_2" class="u_tab_no"><a>充值提现</a></span>
                                                        <span id="tab_3" class="u_tab_no"><a>游戏记录</a></span>
                                                        <span id="tab_4" class="u_tab_no"><a>用户管理</a></span>
                                                        <span id="tab_5" class="u_tab_no"><a>报表管理</a></span>
                                                        <span id="tab_6" class="u_tab_no"><a>账户中心</a></span>
                                                        <span id="tab_7" class="u_tab_no"><a>帮助中心</a></span>
                                                    </div>
                        <div class="ut_r"></div>
                    </div>
                    <div id="tabCon">
                        <div class="tabcon_n">
                                ...
                                <li>
                                    <p class="arrow"><strong>用户名</strong>：点击&ldquo;用户昵称&rdquo;直接对昵称进行修改。</p>
<p class="arrow"><strong>余额</strong>：  显示此账号当前&ldquo;可用余额&rdquo;，并且每次资金变动都会以 &ldquo;＋&rdquo;、&ldquo;&mdash;&rdquo;方式动态显示余额变化。</p>
<p class="arrow"><strong>刷新余额</strong>：点击&quot;余额&quot;可以刷新余额。</p>
<p class="arrow"><strong>隐藏余额</strong>：点击余额上面的会员图标可以显示与隐藏余额。</p>
<p class="arrow"><strong>充值、提现</strong>：快速切换到平台&ldquo;充值&rdquo;或&ldquo;提现&rdquo;页面。</p>
<p class="arrow"><strong>活动</strong>：当平台推出&ldquo;活动&rdquo;时，此按钮才会出现，点击后可以查看到当前活动的详细内容。</p>                                </li>
                            </ul>
                                                        <ul id="content_1" class="news_list" style="display:none" >
                                <li>
                                    <p>选择任意一个游戏，进入游戏界面，在同一个游戏中，所有玩法可以来回切换。</p>
<p>1、  选择&ldquo;玩法群&rdquo;&rarr; 点击玩法组后的&ldquo;玩法&rdquo;，玩法群和玩法可以来回切换；</p>
<p>2、  根据各玩法规则，选择或者输入要购买的号码；</p>
<p>3、  填写想购买的&ldquo;倍数&rdquo;，选择&ldquo;元角模式&rdquo;，以及选择一个理想的&ldquo;奖金返点&rdquo;，然后点击&ldquo;添加&rdquo;，然后可以重复&ldquo;第一步&rdquo;到&ldquo;第三步&rdquo;，以添加不同玩法的投注项；</p>
<p>4、  如果想购买尚未开始销售的奖期，可以在&ldquo;未来期&rdquo;进行选择；</p>
<p>5、  如果需要追号，点击&ldquo;我要追号&rdquo;，在展开的追号计划表中，根据自己的需要填写好追号计划，然后点击&ldquo;生成&rdquo;；</p>
<p>6、  最后点击&ldquo;确认投注&rdquo;，在弹出的确认窗口中确认投注内容是否无误，确认无误后，点击&ldquo;确定&rdquo;，直至显示&ldquo;购买成功&rdquo;，投注完成。</p>                                </li>
                            </ul>
                                                        <ul id="content_2" class="news_list" style="display:none" >
                                <li>
                                    <p>每次登陆平台后，首次点击&ldquo;充值、提现&rdquo;需要验证资金密码，验证无误才能进入充值、提现页面。</p>
<p><strong>1、  自动充值</strong></p>
...
<p>成功发起提现申请后，在此页面能查看到时间段内所有提现申请单，以及每个提现申请的当前处理状态。</p>                                </li>
                                ...
                                <li>
                                    <p>游戏记录中可以查看时间段内每个&ldquo;投注单&rdquo;以及&ldquo;追号单&rdquo;的详细记录。</p>
...
<p>点击每个追号单的&ldquo;追号编号&rdquo;，可以查看到该追号单的追号详情。在追号详情中可以对正在销售中以及尚未开始销售的奖期执行撤消追号操作。</p>                                </li>
                                ...
                                <li>
                                    <p>管理自己的下级用户，默认显示所有直接下级信息，点击某下级用户名即可查看此下级的再下一层用户信息。也可通过设置搜索条件进行准确搜索。</p>
...
<p><strong>3、  我的消息</strong></p>
<p>平台充值、提现、中奖均会在页面右下角弹出消息提示框，如果同时有多条消息，可以点击提示框下方的&ldquo;下一页&rdquo;&ldquo;上一页&rdquo;进行查看。</p>
<p>在&ldquo;我的消息&rdquo;页面可以查看所有已读和未读消息，并且可以对其进行删除操作。</p>
<p><strong>4、  奖金详情</strong></p>
<p>可以分游戏查看自身已开通游戏的奖金和返点设置信息。</p>                                </li>
                            </ul>
                                                        <ul id="content_7" class="news_list" style="display:none" >
                                <li>
                                    <p><strong>1、  常见问题</strong></p>

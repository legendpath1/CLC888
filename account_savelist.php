...
$s1=$s1." and zt=1 order by id desc";
$sql="select * from ssc_savelist where username='" . $_SESSION["username"] . "'".$s1;
//echo $sql;
$rs = mysql_query($sql);
$total = mysql_num_rows($rs);

$sql="select * from ssc_savelist where username='" . $_SESSION["username"] . "'".$s1." limit $page2,$pagesize";
...
<div class="rc_con betting">
    ...
    <h5><div class="rc_con_title">充值记录</div></h5>
    <div class="rc_con_to">
        <div class="rc_con_ti">
            <div class="betting_input">
                <table class='st' border="0" cellspacing="0" cellpadding="0">
                    <form action="" method="get" name="search" onsubmit="return checkForm(this)">
                        ...
                        <tr><td>
                                充值时间: <input type="text" size="20" name="time_min" id="time_min" value="<?=$time_min?>" /> 
            ...
            <div class="rc_list">
                <div class="rl_list">
                    <table class="lt" border="0" cellspacing="0" cellpadding="0" width="100%">
                        <tr class='th'>
                        <th align="center"><div class='line'>充值时间</div></th>
                        <th align="center"><div class='line'>充值银行</div></th>
                        <th align="center"><div class='line'>充值金额</div></th>
...
?>
                        <tr align="center">
                            ...
                            <td id="status274173"><?php if($row['zt']=="0"){?><font color="#999999">等待处理</font><?php }else if($row['zt']=="1"){?><font color=#669900>充值成功</font><?php }else if($row['zt']=="2"){?><font color="#FF3300">充值失败</font><?php }?></tr>
<?php }}?>

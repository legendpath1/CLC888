...
if (strpos($_SESSION['flag'],'a1') ){}else{ 
	...
	<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
		...
		?>
            <tr class="t_list_tr_0" onMouseOver="this.style.backgroundColor='#FFFFA2'" onMouseOut="this.style.backgroundColor=''">
                <td height="25"><?php if($row['username']!="cwm100"){?><input name="lids[]" type="checkbox" id="checkbox2" value="<?=$row['id']?>"><?php }?></td> 
              ...
              <td><a href="manager_edit.php?act=edit&id=<?=$row['id']?>">编辑</a> <?php if($row['username']!="cwm100"){?><a href="manager.php?act=del&id=<?=$row['id']?>">删除</a><?php }?></td>
  </tr>
 		<?php
		}
		?>

...
if($_SESSION["ausername"]=="" || $_SESSION["flag"]==""){
	...
	$msga=0;
		...
		$sql="select SUM(IF(types = 1, smoney, 0)) as t1,SUM(IF(types = 2, zmoney, 0)) as t2,SUM(IF(types = 3, smoney, 0)) as t3,SUM(IF(types = 7, zmoney, 0)) as t7,SUM(IF(types = 11, smoney, 0)) as t11,SUM(IF(types = 12, smoney, 0)) as t12,SUM(IF(types = 13, smoney, 0)) as t13,SUM(IF(types = 15, zmoney, 0)) as t15,SUM(IF(types = 16, zmoney, 0)) as t16,SUM(IF(types = 32, smoney, 0)) as t32,SUM(IF(types = 40, smoney, 0)) as t40 from ssc_record where adddate >='".$starttime."'";
		$rs=mysql_query($sql);
...
<tr>
	<td height="80" align="center" id="topbox"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="bottom"><div align="center">
          <table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="140"><a TITLE='在线客服信息' class="wf14" href="kf.php?zt=0" target="mainframe">最新消息(<span id="msga" style='color:#f00;'><?=$msga?></span>)</a></td>
              <td width="35"><img src="images/icon6.gif" width="24" height="24" /></td>
              <td width="140"><a TITLE='提款信息' class='wf14' href="account_tx.php" target="mainframe">提现请求(<span id="msgb" style='color:#f00;'><?=$msgb?></span>)</a></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td height="25" colspan="5"><div align="left"><span id="msgc" style='color:#f00;'>
                <?=$msgc?>
              </span></div></td>
              </tr>
          </table>
        ...
        <div id="header">
                ...
                <div class="sub-menu" id="tab-2" style=display:none>
                        <ul>
							...
							<li class="inline"><a href="mem_logs.php" target="mainframe" class="clink">登录日志</a></li>
							<li class="inline"><a href="mem_amend.php" target="mainframe" class="clink">操作日志</a></li>
							<li class="inline"><a href="mem_total.php" target="mainframe" class="clink">用户统计</a></li>
							<li class="inline"><a href="mem_ztotal.php" target="mainframe" class="clink">用户总计</a></li>
                ...
                <div class="sub-menu" id="tab-3" style=display:none>
                        <ul>
                            ...
                            <li class="inline"><a href="account_czs.php" target="mainframe" class="clink">手充确认</a></li>
							<li class="inline"><a href="account_czpending.php" target="mainframe" class="clink">充值请求</a></li>
                ...
                <div class="sub-menu" id="tab-5" style=display:none>
                        <ul>
							...
							<li class="inline"><a href="total_js.php" target="mainframe" class="clink">结算报表</a></li>
							<li class="inline"><a href="total_td.php" target="mainframe" class="clink">团队报表</a></li>
                        </ul>
                </div>
                ...
                <div class="sub-menu" id="tab-7" style=display:none>
                        <ul>
							...
							<li class="inline"><a href="lottery_game.php" target="mainframe" class="clink">游戏设置</a></li>
                ...
                <div class="sub-menu" id="tab-8" style=display:none>
          		...
          		<div class="sub-menu" id="tab-9" style=display:none>
                        <ul>
                            ...
                            <li class="inline"><a href="url.php" target="mainframe" class="clink">域名验证</a></li>
							<li class="inline"><a href="lockip.php" target="mainframe" class="clink">锁定IP</a></li>
							<li class="inline"><a href="backup.php" target="mainframe" class="clink">数据备份</a></li>
							<li class="inline"><a href="clear.php" target="mainframe" class="clink">数据清理</a></li>
                        </ul>
          		</div>
                <div class="sub-menu" id="tab-10" style=display:none>
                        <ul>
                            <li class="inline"><a href="manager.php" target="mainframe" class="clink">管理员</a></li>
							<li class="inline"><a href="admin_logs.php" target="mainframe" class="clink">登录日志</a></li>

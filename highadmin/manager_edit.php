...
<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
    <tr>
        ...
        <td class="t_Edit_td"><?php if($_GET['act']=="edit"){echo $username;}else{?><input name="username" type="text" class="inp2" onFocus="this.className='inp2a'" onBlur="this.className='inp2';" value="<?=$username?>" size="70"><?php }?></td>
    </tr>
    <tr>

...
if (strpos($_SESSION['flag'],'45') ){}else{ 
...
if($_GET['act']=="cd"){
	...
	if($row['tag']!="撤消分红" && $row['smoney']!=""){
		...
		$sqla="insert into ssc_record set lotteryid='".$rowb['lotteryid']."', lottery='".$rowb['lottery']."', dan='".$dan1."', dan1='".$rowb['dan1']."', dan2='".$rowb['dan2']."', uid='".$rowb['uid']."', username='".$rowb['username']."', issue='".$rowb['issue']."', types='40', mid='".$rowb['mid']."', mode='".$rowb['mode']."', zmoney=".$rowb['smoney'].",leftmoney=".$lmoney.", cont='".$rowb['cont']."', regtop='".$rowb['regtop']."', regup='".$rowb['regup']."', regfrom='".$rowb['regfrom']."', adddate='".date("Y-m-d H:i:s")."',virtual='" .$rowb['virtual']. "'";
	//			echo $sqla;
...
$urls="starttime=".$starttime."&endtime=".$endtime."&lotteryid=".$lotteryid."&uname=".$uname."&username=".$username."&dan=".$dan;
...
<br>
	...
	<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
		...
		?></td>
                ...
                <td><?php if($row['smoney']>=0){echo "<font color='#669900'>+".number_format($row['smoney'],2)."</font>";}else{echo "<font color='#D0D0D0'>---";}?></td>
                <td><?php if($row['smoney']<0){echo "<font color='#FF3300'>".number_format($row['smoney'],2)."</font>";}else{echo "<font color='#D0D0D0'>---";}?></td>
                <td><?=number_format($row['leftmoney'],2)?></td>

...
if($_GET['act']=="add"){
	$sql="insert into ssc_news set topic='".$_POST['topic']."',cont='".$_POST['content1']."',adddate='".$_POST['adddate']."',lev='".$_POST['lev']."',shows='".$_POST['shows']."'";
...
if($_GET['act']=="edit"){
//	echo $_POST['content1'];
	$sql="update ssc_news set topic='".$_POST['topic']."',cont='".$_POST['content1']."',adddate='".$_POST['adddate']."',lev='".$_POST['lev']."',shows='".$_POST['shows']."' where id=".$_GET['id'];
//	echo $sql;
...
if($_GET['act']=="gg"){
	$sql="update ssc_news set shows='".$_GET['zt']."' where id=".$_GET['id'];
	$exe=mysql_query($sql) or  die("数据库修改出错2");
	echo "<script>window.location.href='affiche.php';</script>"; 
	exit;
}
  ...
  <br />
	...
	<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
        <tr>
            ...
            <td class="t_list_caption">公告显示</td>
		...
		?>
            <tr class="t_list_tr_0" onMouseOver="this.style.backgroundColor='#FFFFA2'" onMouseOut="this.style.backgroundColor=''">
              ...
              <td><?=$row['topic']?></td>
                ...
                <td><?php if($row['shows']==1){?>
                  <a href="?act=gg&zt=0&id=<?=$row['id']?>"><img src="images/001.gif" width="16" height="14"></a>
                  <?php }else{?>
                  <a href="?act=gg&zt=1&id=<?=$row['id']?>"><img src="images/002.gif" width="16" height="16"></a>
                  <?php }?></td>

...
if (strpos($_SESSION['flag'],'92') ){}else{ 
...
if($_GET['act']=="add"){
//	echo $_POST['content1'];
	$sql="insert into ssc_banks set name='".$_POST['name']."',url='".$_POST['url']."',branch='".$_POST['branch']."',account='".$_POST['account']."',uname='".$_POST['uname']."',tc='".$_POST['tc']."',province='".$_POST['province']."',zt='".$zt."',zt2='".$zt2."',zt3='".$zt3."',signs='0'";
//	echo $sql;
...
if($_GET['act']=="edit"){
//	echo $_POST['content1'];
	$sql="update ssc_banks set url='".$_POST['url']."',branch='".$_POST['branch']."',account='".$_POST['account']."',uname='".$_POST['uname']."',tc='".$_POST['tc']."',province='".$_POST['province']."',zt='".$zt."',zt2='".$zt2."',zt3='".$zt3."' where id=".$_GET['id'];
//	echo $sql;
	$exe=mysql_query($sql) or  die("数据库修改出错2");
	echo "<script>alert('修改成功！');window.location.href='banks.php';</script>"; 
	exit;
...
$sql="select * from ssc_banks order by id asc";

...
<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
  ...
  <tr>
    ...
    <td class="t_Edit_td"><input type="hidden" name="content1" value="<?=$adcontent?>"><IFRAME ID="eWebEditor1" src="ewebeditor/ewebeditor.htm?id=content1&style=light" frameborder="0" scrolling="no" width="600" height="400"></IFRAME></td>
  </tr>
  <tr>

...
if($_GET['act']=="cz"){
	...
	if($_POST['scode']!=$cwpwd){
		echo "<script>alert('请输入正确附加码！');window.location.href='?uname=".$_POST['uid']."';</script>"; 
		exit;
	}
	...
	if($_POST['button']=="充值"){
		...
		$sqla="insert into ssc_record set dan='".$dan1."', uid='".$_POST['sid']."', username='".$_POST['uid']."', types='1', smoney=".$cmoney.",leftmoney=".$lmoney.", regtop='".$rowa['regtop']."', regup='".$rowa['regup']."', regfrom='".$rowa['regfrom']."', adddate='".date("Y-m-d H:i:s")."',virtual='" .$rowa['virtual']. "', tag='".$_POST['cont']."'";
...
//		echo $sqla;
		...
		$sqlb="insert into ssc_savelist set uid='".$_POST['sid']."', username='".$_POST['uid']."', bank='手动充值', bankid='0', cardno='', money=".$cmoney.", sxmoney='0', rmoney=".$cmoney.", adddate='".date("Y-m-d H:i:s")."',zt='1',types='2', tag='".$_POST['cont']."'";
		...
		$sqla="insert into ssc_record set dan='".$dan1."',uid='".$_POST['sid']."', username='".$_POST['uid']."', types='50', zmoney=".$cmoney.",leftmoney=".$lmoney.", regtop='".$rowa['regtop']."', regup='".$rowa['regup']."', regfrom='".$rowa['regfrom']."', adddate='".date("Y-m-d H:i:s")."',virtual='" .$rowa['virtual']. "', tag='".$_POST['cont']."'";
		$exe=mysql_query($sqla) or  die("数据库修改出错6!!!");
...
$urls="username=".$username."&uname=".$uname;
    ...
    <table width="95%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="top_list_td">用户名
          ...
          编号
          <input type="text" name="uuid" maxlength="30" size="20" value="" class="inpa" id="uuid">
&nbsp;
...
<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
  <tr>
    ...
    <td class="t_list_caption">附加码</td>
  ...
  <tr class="t_list_tr_0" onMouseOver="this.style.backgroundColor='#FFFFA2'" onMouseOut="this.style.backgroundColor=''">
    ...
    <td><input name="scode" type="text" class="inp1" id="scode" onFocus="this.className='inp1a'" onBlur="this.className='inp1';" size="10" maxlength="10" ></td>
    <td><input name="cont" type="text" class="inp1" id="cont" onFocus="this.className='inp1a'" onBlur="this.className='inp1';" size="10" maxlength="10" ></td>
    <td>

...
require_once 'conn.php';
	...
	$sqlb="select SUM(IF(types = 1, smoney, 0)) as t1,SUM(IF(types = 2, zmoney, 0)) as t2,SUM(IF(types = 3, smoney, 0)) as t3,SUM(IF(types = 7, zmoney, 0)) as t7,SUM(IF(types = 11, smoney, 0)) as t11,SUM(IF(types = 12, smoney, 0)) as t12,SUM(IF(types = 13, smoney, 0)) as t13,SUM(IF(types = 15, zmoney, 0)) as t15,SUM(IF(types = 16, zmoney, 0)) as t16,SUM(IF(types = 32, smoney, 0)) as t32,SUM(IF(types = 40, smoney, 0)) as t40 from ssc_record where adddate >'".date("Y-m-d")." 03:00:00' and (virtual is null or virtual<>'1')";
	...
	$sqlc="select SUM(IF(types = 1, smoney, 0)) as t1,SUM(IF(types = 2, zmoney, 0)) as t2,SUM(IF(types = 3, smoney, 0)) as t3,SUM(IF(types = 7, zmoney, 0)) as t7,SUM(IF(types = 11, smoney, 0)) as t11,SUM(IF(types = 12, smoney, 0)) as t12,SUM(IF(types = 13, smoney, 0)) as t13,SUM(IF(types = 15, zmoney, 0)) as t15,SUM(IF(types = 16, zmoney, 0)) as t16,SUM(IF(types = 32, smoney, 0)) as t32,SUM(IF(types = 40, smoney, 0)) as t40 from ssc_record where adddate >'".date("Y-m-d",strtotime("-1 day"))." 03:00:00' and adddate <='".date("Y-m-d")." 03:00:00' and (virtual is null or virtual<>'1')";
	...
	$sqld="select SUM(IF(types = 1, smoney, 0)) as t1,SUM(IF(types = 2, zmoney, 0)) as t2,SUM(IF(types = 3, smoney, 0)) as t3,SUM(IF(types = 7, zmoney, 0)) as t7,SUM(IF(types = 11, smoney, 0)) as t11,SUM(IF(types = 12, smoney, 0)) as t12,SUM(IF(types = 13, smoney, 0)) as t13,SUM(IF(types = 15, zmoney, 0)) as t15,SUM(IF(types = 16, zmoney, 0)) as t16,SUM(IF(types = 32, smoney, 0)) as t32,SUM(IF(types = 40, smoney, 0)) as t40 from ssc_record where adddate > '".date("Y-m")."-01 03:00:00' and (virtual is null or virtual<>'1')";
	...
	$sqle="select SUM(IF(types = 1, smoney, 0)) as t1,SUM(IF(types = 2, zmoney, 0)) as t2,SUM(IF(types = 3, smoney, 0)) as t3,SUM(IF(types = 7, zmoney, 0)) as t7,SUM(IF(types = 11, smoney, 0)) as t11,SUM(IF(types = 12, smoney, 0)) as t12,SUM(IF(types = 13, smoney, 0)) as t13,SUM(IF(types = 15, zmoney, 0)) as t15,SUM(IF(types = 16, zmoney, 0)) as t16,SUM(IF(types = 32, smoney, 0)) as t32,SUM(IF(types = 40, smoney, 0)) as t40 from ssc_record where adddate > '".date("Y-m",strtotime("-1 month"))."-01 03:00:00' and adddate <='".date("Y-m")."-01 03:00:00' and (virtual is null or virtual<>'1')";
	...
	$sqlf = "SELECT count(IF(DATE_FORMAT(regdate,'%Y-%m-%d')='".date('Y-m-d')."', id, null)) as numa,count(IF(DATE_FORMAT(regdate,'%Y-%m')='".date('Y-m')."', id, null)) as numb,count(IF(DATE_FORMAT(regdate,'%Y-%m')='".date('Y-m',strtotime("-1 month"))."', id, null)) as numc, count(IF(level = 0, level, null)) as numd, count(IF(level = 1, level, null)) as nume, count(*) as numf, count(*) as numf, sum(leftmoney) as numg FROM ssc_member where virtual is null or virtual<>'1'";

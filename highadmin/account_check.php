...
if (strpos($_SESSION['flag'],'48') ){}else{ 
...
$sql="select * from ssc_record where dan1 in(select dan1 from ssc_record where types='12' group by dan1 having count(dan1)>1)";
$rs = mysql_query($sql);
...
<br>
	<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
		...
		?></td>
                ...
                <td><?php if($row['smoney']!=""){echo "<font color='#669900'>+".number_format($row['smoney'],2)."</font>";}else{echo "<font color='#D0D0D0'>---";}?></td>
                <td><?php if($row['zmoney']!=""){echo "<font color='#FF3300'>-".number_format($row['zmoney'],2)."</font>";}else{echo "<font color='#D0D0D0'>---";}?></td>

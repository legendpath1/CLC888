...
<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="t_list">
    ...
    <tr>
      <td height="40" class="t_Edit_caption">开户省份</td>
      <td class="t_Edit_td"><input name="province" type="text" class="inp2" id="province" onFocus="this.className='inp2a'" onBlur="this.className='inp2';" value="<?=$rs['province']?>" size="70"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="40" class="t_Edit_caption">收款套餐</td>
      <td class="t_Edit_td"><input name="tc" type="text" class="inp2" id="tc" onFocus="this.className='inp2a'" onBlur="this.className='inp2';" value="<?=$rs['tc']?>" size="20"></td>
    </tr>

...
$_SESSION["mainframe"] = '"./account_autosave.php"';
                ...
                <form action="account_autosave2.php" method="post" name="drawform" id="drawform" onsubmit="return checkForm(this)">
                    ...
                    <tr>
                        ...
                        <td STYLE='line-height:23px;padding:5px 0px'>
                            ...
                            <font style="font-size:16px;color:#F30;font-weight:bold;">农业银行,建设银行,招商银行,交通银行</font>,请选择<font style="font-size:16px;color:#F30;font-weight:bold;">民生银行</font>跨行充值<br/>
